...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dq2lnjg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dq2lnjg.containers.anotherwebservice.com/
...
```
git clone git@github.com:Zeltoria/container-dq2lnjg.git
cd container-dq2lnjg
```
...
```
docker attach container-dq2lnjg
```
